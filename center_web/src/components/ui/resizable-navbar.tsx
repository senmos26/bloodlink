...
export const NavbarLogo = () => {
  return (
    ...
    >
      ...
      <span className="font-medium text-black dark:text-white">BloodLink</span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  children: React.ReactNode;
  className?: string;
  variant?: "primary" | "secondary" | "dark" | "gradient" | "green";
} & (
  ...
  const variantStyles = {
    ...
    green:
      "bg-[#3a6873] text-white shadow-[0_0_24px_rgba(58,_104,_115,_0.3),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(58,_104,_115,_0.2),_0_0_4px_rgba(58,_104,_115,_0.2),_0_16px_68px_rgba(58,_104,_115,_0.1),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] hover:bg-[#335b66]",
  };
