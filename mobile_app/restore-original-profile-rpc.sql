-- Restaurer la fonction update_my_profile originale
-- Sans les champs gender et next_donation_date
-- Exécutez cette commande dans l'éditeur SQL Supabase

-- 1. Supprimer la fonction actuelle
DROP FUNCTION IF EXISTS update_my_profile;

-- 2. Recréer la fonction originale
