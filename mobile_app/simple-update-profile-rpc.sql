-- Version ultra-simplifiée de update_my_profile
-- Évite complètement le problème de colonne id ambiguous
...
-- 2. Créer la fonction ultra-simplifiée
...
BEGIN
  ...
  -- Mettre à jour le profil (simple mise à jour, pas de retour)
  UPDATE profiles
  SET 
